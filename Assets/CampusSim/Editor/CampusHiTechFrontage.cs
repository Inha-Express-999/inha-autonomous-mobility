...
public static class CampusHiTechFrontage
{
    public static void Fit()
    {
        ...
        for(int j=0;j<=columns;j++)
        {
            ...
            float end=portal.InverseTransformPoint(landmark.accessibleEntrance.position).x+1.6f;
        ...
        const string path="Assets/CampusSim/Generated/EntranceApproaches/HiTechSharedFrontage.asset";
        ...
        var area=child.GetComponent<CampusPedestrianArea>();area.areaId="hitech_shared_frontage";area.localBoundary=polygon;area.excludeFromVehicleRouting=true;area.pedestrianAccessVerified=false;area.source="Synthetic sidewalk connection; measured access and Stop routing unverified.";
        ...
        File.WriteAllText("Docs/MapResearch/Iterations/hitech-shared-frontage.txt",$"Width=2.5m; top samples={(rows+1)*(columns+1)}; maximum longitudinal grade={maxGrade}; terrain burial={maxBurial}; {columns+1} terminal samples gap to accessible approach={minGap}..{maxGap}m. Authoring geometry only.");
    }
}
