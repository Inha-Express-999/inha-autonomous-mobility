...
public static class CampusDormitoryOneFrontage
{
    public static void Fit()
    {
        var landmark=UnityEngine.Object.FindObjectsByType<CampusLandmarkEntrances>(FindObjectsSortMode.None).Single(x=>x.landmarkId=="dorm_1");
        ...
        const string path="Assets/CampusSim/Generated/EntranceApproaches/Dormitory1SharedFrontage.asset";
        ...
        var area=child.GetComponent<CampusPedestrianArea>();area.areaId="dormitory1_shared_frontage";area.localBoundary=polygon;area.excludeFromVehicleRouting=true;area.pedestrianAccessVerified=false;area.source="Synthetic sidewalk connection; measured access and Stop routing unverified.";
        ...
        File.WriteAllText("Docs/MapResearch/Iterations/dormitory1-shared-frontage.txt",$"Width=1.8m; top samples={(rows+1)*(columns+1)}; maximum longitudinal grade={maxGrade}; terrain burial={maxBurial}; {columns+1} terminal samples gap to accessible approach={minGap}..{maxGap}m. Authoring geometry only.");
    }
}
