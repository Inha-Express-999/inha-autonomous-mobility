...
s['before']=np.fromfile(s['OUT']/'FineTerrain/gates-before.raw','<f4').reshape(1025,1025)
...
if result.info.status=='solved':
    ...
    after.tofile(out/'FineTerrain/gates-proposal.raw')
(out/'FineTerrain/gates-report.json').write_text(json.dumps(report,indent=2),encoding='utf-8')
