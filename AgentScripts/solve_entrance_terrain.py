...
s['before']=np.fromfile(s['OUT']/'FineTerrain/entrance-before.raw','<f4').reshape(1025,1025)
...
if result.info.status=='solved':
    ...
    after.tofile(out/'FineTerrain/entrance-proposal.raw')
(out/'FineTerrain/entrance-report.json').write_text(json.dumps(report,indent=2),encoding='utf-8')
