...
s['before']=np.fromfile(s['OUT']/'FineTerrain/baseline-1025.raw','<f4').reshape(1025,1025)
...
if result.info.status=='solved':
    ...
    after.tofile(out/'FineTerrain/joint-proposal.raw')
(out/'FineTerrain/joint-report.json').write_text(json.dumps(report,indent=2),encoding='utf-8')
