...
프로젝트 버전: **0.1.2.0**. [통합 개발 규칙](AGENTS.md), [지도 작업 현황](Docs/MapResearch/PLAN.md), [PC·모바일 UI 명세](Docs/ClientUI/REQUIREMENTS.md), [화면별 적용·검증 계획](Docs/ClientUI/IMPLEMENTATION.md)을 기준으로 개발합니다. PC·모바일 클라이언트의 Bootstrap·Additive 씬 및 빌드 프로필 골격이 추가되었으며, 실제 UI와 Python 서버 연동은 구현 예정입니다.
